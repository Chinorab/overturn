...
<link href="https://fonts.googleapis.com/css2?family=Public+Sans:wght@400;600&family=Fraunces:ital,opsz,wght@0,9..144,400..600;1,9..144,400..600&display=swap" rel="stylesheet">
<style>
  ...
  .brand { font-family:"Fraunces", serif; font-variation-settings:"opsz" 32, "SOFT" 40; font-weight:600; color:#134e5e; font-size:28px; letter-spacing:-.01em; }
  h1 { font-family:"Fraunces", Georgia, serif; font-weight:500; font-variation-settings:"opsz" 144, "SOFT" 30; font-size:68px; line-height:1.02; margin:26px 0 0; color:#134e5e; letter-spacing:-.022em; }
  ...
  .pill { box-shadow:0 0 0 1px rgba(19,78,94,.10); background:#fff; border-radius:999px; padding:10px 18px; font-size:20px; color:#134e5e; }
  .card { position:absolute; right:72px; bottom:56px; width:330px; background:#fffdf9; border-radius:22px; padding:20px 22px; box-shadow:inset 0 1px 0 rgba(255,255,255,.85), 0 0 0 1.5px rgba(19,78,94,.45), 0 24px 60px -20px rgba(19,78,94,.30); }
  .card .k { font-size:13px; letter-spacing:.08em; text-transform:uppercase; color:#134e5e; font-weight:600; }
  .card .d { font-family:"Fraunces", serif; font-size:30px; font-weight:500; margin-top:8px; line-height:1.15; }
