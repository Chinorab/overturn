...
| 0:15–0:35 | Landing page on phone. Pause on the three cards: *Information, not advice · Not a lawyer · Nothing stored*. Tap "ER visit billed out of network". | "It works with the document you already have: a denial letter or an Explanation of Benefits. Before you upload anything, it tells you what it is and what it is not. Let's use a sample." |
